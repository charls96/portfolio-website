...
import './socialContactCommon.css'

function socialContactCommon() {

    return (
        <div className='social-contact'>
                   
                        <div className='social-icons'>
                            <a href="https://github.com/charls96">
                                <svg className='social-icon' xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512">
                            ...
                            <a href="/index">
                                <svg className='social-icon' id='social-icon-margin' xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                    <g fill="none">
...
export default socialContactCommon
